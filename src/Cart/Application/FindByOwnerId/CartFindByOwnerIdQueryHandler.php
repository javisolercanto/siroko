...
#[AsMessageHandler()]
class CartFindByOwnerIdQueryHandler
{
    public function __construct(
        private readonly CartFindByOwnerIdUseCase $useCase,
        private readonly CartResponseConverter $converter,
    ) {}

    public function __invoke(CartFindByOwnerIdQuery $query): ?CartResponse
    {
        /** @var Cart|null $cart */
